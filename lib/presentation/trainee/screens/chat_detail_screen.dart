...
class _ChatDetailScreenState extends State<ChatDetailScreen> {
  ...
  Future<void> _startRecording() async {
    ...
    try {
      ...
      if (hasPermission) {
        ...
        debugPrint('Recording: starting at path $path');
  ...
  void _sendMessage({
    ...
    final text = messageContent ?? _controller.text.trim();
    ...
    if (success) {
      ...
      if (chatProvider.errorMessage ==
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("You need an active subscription to send messages."),
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: Colors
                          .grey[200], // Changed to match the screenshot better
          ...
          GestureDetector(
            onTap: () {
              ...
              final ImageProvider imageProvider =
                  ...
                  : AssetImage(imageUrl ?? 'assets/images/trainee photo1.jpg')
                        as ImageProvider;
        ...
        children: [
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Row(
                      ...
                      children: [
                        // If it's an image, we might want the time inside the image or below?
                        // Currently keeping it below inside the bubble container which wraps everything.
                        if (type == 'image')
                          Spacer(), // Push time to right if image
          ...
          if (isMe) ...[
            ...
            CircleAvatar(
              radius: 16.r,
              backgroundImage:
                  (context.read<TraineeProvider>().trainee?.profileImageUrl !=
                          null &&
                      context
                          .read<TraineeProvider>()
                          .trainee!
                  ...
                  : const AssetImage('assets/images/trainee photo1.jpg')
                        as ImageProvider,
            ),
          ],
        ],
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            ...
            child: Icon(
              Icons.send, // Or a custom arrow icon
              color: custom_theme.Custom().colors().lightGreen,
              size: 28.sp,
            ),
          ),
  ...
  Widget _buildWorkoutMessage(Map<String, dynamic> msg) {
    // If workout details are returned in the message (as per backend spec)
