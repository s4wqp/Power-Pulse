      ...
      <div key={msg.id || idx} style={{
        ...
        <div style={{
          ...
          {msgType === 'image' && fileUrl && (
            <img src={fileUrl} alt="Sent" style={{ maxWidth: '100%', borderRadius: '12px', display: 'block', maxHeight: '200px', objectFit: 'cover', cursor: 'pointer' }} onClick={() => setFullscreenImage(fileUrl)} />
          )}
          {msgType === 'document' && (
